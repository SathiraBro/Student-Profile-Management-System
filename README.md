# Student Profile Management System - SetUp Guidlines

I use SSMS to save my databasae so this project build around a local database. You should play around to add your database according to your needs or you can follow below steps to create a database that use by myself.
